...
export const bento: VisualStyleDefinition = {
  ...
  tokens: {
    ...
    '--ui-card-shadow': '0 12px 28px color-mix(in srgb, var(--foreground) 10%, transparent)',
    '--ui-card-backdrop': 'none',
    '--ui-button-radius': '1rem',
    '--ui-button-border-width': '0px',
    '--ui-button-border-color': 'transparent',
    '--ui-button-shadow': '0 6px 16px color-mix(in srgb, var(--primary) 20%, transparent)',
    '--ui-button-active-shadow': '0 2px 6px color-mix(in srgb, var(--primary) 20%, transparent)',
  ...
  darkTokens: {
    ...
    '--ui-card-shadow': '0 16px 32px color-mix(in srgb, var(--foreground) 10%, transparent)',
