...
- Panel: clientes, demos de prospecto (crear, enviar el enlace por WhatsApp, seguir visitas, extender, descartar, convertir en cliente y, para la dueña, métricas del embudo por rubro, kit, vendedor y mes), dominios, páginas y bloques, identidad, biblioteca de imágenes, menú, mensajes, blog, tienda, usuarios, claves de agente y registro de actividad.
